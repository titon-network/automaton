...
import { DeploymentNotAvailableError } from '../chain/deployment';
        ...
        case 'mainnet':
            throw new DeploymentNotAvailableError(
                'Kronos mainnet deployment is not yet live. Testnet addresses are in ' +
                    '@titon-network/kronos-sdk as KRONOS_TESTNET; when mainnet lands a ' +
                    'KRONOS_MAINNET constant will ship in the same place.',
            );
    }
}
