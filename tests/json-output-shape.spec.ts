...
describe('JSON output shapes (drift guard)', () => {
    ...
    it('doctor: DoctorJsonPayload shape (snapshot)', () => {
        const canned: NamedCheckResult[] = [
            ...
            { name: '@titon-network/forgeton-sdk resolves', status: 'ok', detail: '26 exports' },
            { name: '@titon-network/kronos-sdk resolves', status: 'ok', detail: '30 exports' },
            {
            ...
            `
{
  "checks": [
    ...
    {
      "detail": "30 exports",
      "name": "@titon-network/kronos-sdk resolves",
      "status": "ok",
    },
    {
      "detail": "1 TON < 2 TON (minFreeBalance)",
