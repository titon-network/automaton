...
1. `node_modules/@titon-network/forgeton-sdk/dist/index.js` exists (sibling SDK was built before snapshot).
2. `node_modules/@titon-network/kronos-sdk/dist/index.js` exists (same).
3. `../forgeton/sdks/typescript/node_modules/` does NOT exist (a nested install duplicates `@ton/core`).
4. `../kronos/sdks/typescript/node_modules/` does NOT exist (same).
