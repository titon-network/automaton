...
`@titon-network/automaton` is the binary that operators run on their own infrastructure to stake and execute Kronos jobs on TON. A vulnerability here puts operator stake at risk. Please report responsibly.
