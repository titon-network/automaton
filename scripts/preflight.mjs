...
const SDKS = [
    { name: '@titon-network/forgeton-sdk', sibling: '../forgeton/sdk', optional: false },
    { name: '@titon-network/kronos-sdk', sibling: '../kronos/sdk', optional: false },
    { name: '@titon-network/atlas-sdk', sibling: '../atlas/sdk', optional: true },
    { name: '@titon-network/fortuna-sdk', sibling: '../fortuna/sdk', optional: true },
];
